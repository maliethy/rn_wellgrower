...
import { Content, Form, Item, Label, Input, Button, Text, Picker } from 'native-base';
    ...
    <Content style={wrapper}>
      <Form style={form}>
        ...
        <Item inlineLabel style={item}>
          ...
          <Input style={input} value={name} onChangeText={(value) => setName(value)} />
        </Item>
        <Item inlineLabel style={item}>
        ...
        <Button primary style={btn} onPress={this.onPress}>
